...
@Component({
  selector: 'ng-custom-card-model',
  templateUrl: './ng-custom-card-model.component.html',
  styleUrls: ['./ng-custom-card-model.component.scss']
})
export class NgCustomCardModelComponent implements OnInit {
  @Input('name') name: any;
  ...
  @ViewChild('PopUpOpenClose')PopUpOpenClose:any=ElementRef;
